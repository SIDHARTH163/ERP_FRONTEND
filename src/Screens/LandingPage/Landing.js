...
axios.get(`get_user` , {
    ...
    if (res.data.role === 0) {
      ...
      navigate('/teachers_workspace')
      
    }
    else if (res.data.role === 2) {
      navigate('/student_workspace')
    }
              ...
              <div className="items-center flex flex-wrap">
                <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                  <div className="pr-12">
                    ...
                    <button onClick={auth} className="mt-8 bg-slate-900 hover:bg-gray-900 hover:scale-105  p-2 rounded-md  text-lg text-gray-300">
